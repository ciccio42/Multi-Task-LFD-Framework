...
for MODEL in mosaic-baseline-sav-folder/baseline-1/1Task-Pick-Place-Obj-Paper-Batch128; do
    for S in 0 8096 17204 35420; do
        for TASK in pick_place; do
            ...
            python3 $BASE_PATH/repo/mosaic/tasks/test_models/test_any_task.py $MODEL --env $TASK --saved_step $S --eval_each_task 10 --num_workers 1 --project_name "object-paper" --wandb_log
        done
    done
done
